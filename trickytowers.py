...
iblocks: List[pymunk.Shape] = []  # lists of sprites
lblocks: List[pymunk.Shape] = []
jblocks: List[pymunk.Shape] = []
sblocks: List[pymunk.Shape] = []
zblocks: List[pymunk.Shape] = []
oblocks: List[pymunk.Shape] = []
tblocks: List[pymunk.Shape] = []
